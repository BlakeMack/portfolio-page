        ...
        <div className="i-left-wrapper">
            ...
            <div className="i-title">
              <div className="i-title-wrapper">
                <div className="i-title-item">Freelance Web Developer</div>
            ...
            <div className="i-desc">
              I am a Web development bootcamp graduate with a passion for building modern web products and user interfaces, and acquiring new skills and technologies.
            </div>
          </div>
        </div>
        <svg
